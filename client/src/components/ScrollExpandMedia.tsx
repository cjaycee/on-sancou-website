 ...
 * Adapted from 21st.dev for React (no Next.js Image component)
 *
 * Design Philosophy: Elevated Editorial Athleticism
 * - Warm off-white backgrounds, deep charcoal text
 * - Playfair Display for hero headlines, DM Sans for body
 * - ON Red (#E8002D) for CTAs only
 * - Generous whitespace, editorial photography treatment
 */
            ...
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                ...
                <div className='flex flex-col items-center text-center relative z-10 mt-4 transition-none'>
                  {date && (
                    <p
                      className='text-2xl text-white/80 font-light tracking-widest uppercase'
